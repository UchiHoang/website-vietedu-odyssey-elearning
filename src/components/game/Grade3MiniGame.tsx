...
import { loadStory, findActivityByRef, Activity, getBadgeInfo, StoryData, loadCurriculum} from "@/utils/grade3Loader";
import { useGameEngine } from "@/hooks/use3Engine";
...
if (!story) {
        ...
        <div className="max-w-2xl w-full text-center space-y-8 animate-fade-in">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
              Bạn đã hoàn thành hành trình săn kho báu sông Hồng!
            </p>
          </div>
  ...
  if (gamePhase === "cutscene" && currentNode) {
    ...
    const enhancedFrames = currentNode.cutscene.map((frame: any) => {
      ...
      if (frame.speaker === "Nhà thám hiểm" || frame.speaker.includes("thám hiểm")) {
